---Unit tests for marker-groups logger module
...
describe('marker-groups logger module', function()
  before_each(function()
    -- Reset logger state
    logger.setup(true) -- Force re-initialization
    logger.clear()
  end)
  ...
  describe('log buffer management', function()
    ...
    it('should limit buffer size', function()
      ...
      local logs = logger.get_logs()
      -- Should be limited to around 1000 lines plus header
      assert.is_true(#logs <= 1010) -- Account for header and some tolerance
    end)
  end)
  ...
  describe('status reporting', function()
    ...
    it('should count log entries correctly', function()
      ...
      -- Should have 2 more log entries
